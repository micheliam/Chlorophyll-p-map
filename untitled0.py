...
rb= cc.data[527:612,96:167,:]
rb.shape
#rb.shape is (85,71, 400)
...
C2=cc.data[10765,339,:]
C2=ref[10765,339,:]
#pixel 3 Millepora
C3=cc.data[10138, 323,:]
C3=ref[10138, 323,:]
...
C5=cc.data[8578,492,:]
C5=ref[8578,492,:]
#set y axis for wavelength (nm) in curacao
yc=np.linspace(400,798,num=200)
