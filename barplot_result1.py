...
#Coral
plt.figure()
sns.barplot(data=df1, y='Coverage', hue='Depth', x='Species')
plt.title('Top 5 Coral Species in different depths')
plt.xlabel("Species")
plt.ylabel("Coverage(%)")
plt.show()
plt.savefig('/home/michelia.wibowo/labspaces/curacao-reef-mapping/data/work/Michelia/results_barplot_coral_depth_coverage.png')
#Others
plt.figure()
sns.barplot(data=df2, y='Coverage', hue='Depth', x='Species')
plt.title('Macroalgae, Corallinales and Microbial mats in different depths')
plt.xlabel("Reef Groups")
plt.ylabel("Coverage(%)")
plt.show()
plt.savefig('/home/michelia.wibowo/labspaces/curacao-reef-mapping/data/work/Michelia/results_barplot_microbialmacroalgae_depth_coverage.png')

#infra coverage plot
#Coral
plt.figure()
sns.barplot(data=df1, y='Coverage', hue='Infrastructure', x='Species')
plt.title('Top 5 Coral Species in different levels of infrastructure')
plt.xlabel("Species")
plt.ylabel("Coverage(%)")
plt.show()
plt.savefig('results_barplot_coral_infra_coverage.png')
#Others
plt.figure()
sns.barplot(data=df2, y='Coverage', hue='Infrastructure', x='Species')
plt.title('Macroalgae, Corallinales and Microbial mats in different levels of infrastructure')
plt.xlabel("Reef Groups")
plt.ylabel("Coverage(%)")
plt.show()
plt.savefig('results_barplot_microbialmacroalgae_infra_coverage.png')
...
#Coral
plt.figure()
sns.barplot(data=df1, y='AvgChl', hue='Depth', x='Species')
plt.title('Top 5 Coral Species in different depths')
plt.xlabel("Species")
plt.ylabel("Chl-p")
plt.show()
plt.savefig('results_barplot_top5coral_depth_chl.png')
#Others
plt.figure()
sns.barplot(data=df2, y='AvgChl', hue='Depth', x='Species')
plt.title('Macroalgae, Corallinales and Microbial mats in different depths')
plt.xlabel("Reef Groups")
plt.ylabel("Chl-p")
plt.show()
plt.savefig('results_barplot_macrobialmicroalgae_depth_chl.png')

#infra chl plot
#Coral
plt.figure()
sns.barplot(data=df1, y='AvgChl', hue='Infrastructure', x='Species')
plt.title('Top 5 Coral Species in different levels of infrastructure')
plt.xlabel("Species")
plt.ylabel("Chl-p")
plt.show()
plt.savefig('results_barplot_top5coral_infra_chl.png')
#Others
plt.figure()
sns.barplot(data=df2, y='AvgChl', hue='Infrastructure', x='Species')
plt.title('Macroalgae, Corallinales and Microbial mats in different levels of infrastructure')
plt.xlabel("Reef Groups")
plt.ylabel("Chl-p")
plt.show()
plt.savefig('results_barplot_macrobialmicroalgae_infra_chl.png')
...
#example
#plt.figure()
#ax = sns.barplot(x="Species", y="Coverage", hue='Depth', data=dx1)
#plt.show()
#dx1["Pixels"]